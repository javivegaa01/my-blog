...
Si estas leyendo este post para informarte de IPv6 deberias tener claro como funciona IPv4 te dejo los apuntes de otro curso sobre IPv4 [Curso Redes TCP/IP](../apuntes/curso_tcp_ip.md)
